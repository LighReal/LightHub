...
v0.new("<Color=Cyan>Welcome to Light  Hub<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v170.Image = "http://www.roblox.com/asset/?id="   .. tostring(17678806997) ;
...
v8.Image = "rbxassetid://9614132122";
v8.Draggable = true;
...
v74:Button("Kaitun Cap", function(v471)
	...
	for v863, v864 in pairs(v472) do
		if (v495[v864] and (game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"   .. v864 , true) == 1)) then
			...
			v1663.Image = "rbxassetid://9945562382";
